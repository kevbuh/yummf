  ...
  return (
    <div>
      <div className="grid grid-cols-2 max-w-6xl mx-auto mt-4">
        <a className="btn btn-ghost normal-case text-3xl text-rosa mr-auto my-auto">
          kooki
        </a>
        <div className="grid grid-cols-3 ml-auto my-auto gap-4 ">
          ...
          <a className="text-xl font-semibold rounded-xl bg-stone-100 p-2 text-center cursor-pointer">
            Log in
          </a>
          <a className="text-xl font-semibold rounded-xl bg-rosa text-white p-2 cursor-pointer">
            Sign up
          </a>
        </div>
      </div>
      ...
      <div className="h-screen grid grid-cols-2">
        ...
        <div className="m-auto h-1/2">
          <div className="text-7xl font-semibold">Sign Up &</div>
          <div className="text-7xl font-semibold">
              ...
              <div className="bg-stone-100 px-2 rounded-xl flex flex-col ">
                {isSuccess && !isLoading && !isError && data?.user ? (
                  ...
                  <div className="p-2">
                    ...
                    >
                      <Form>
                        <div className="rounded-lg bg-stone-100 px-8  flex flex-col ">
