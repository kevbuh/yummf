    ...
    <footer className="footer px-10 pt-10 pb-8 bg-base-300 text-base-content">
      ...
      <div>
        ...
        <div className="form-control ">
          ...
          <span className="footer-title">Get Started Today</span>
          {/* </label> */}
          <div className="relative">
            <input
              type="text"
              placeholder="username@site.com"
              className="bg-stone-100 p-3 rounded-xl"
            />
            <button className="rounded-xl p-3 ml-1 font-semibold bg-stone-100">
              Sign up
            </button>
          </div>
        </div>
